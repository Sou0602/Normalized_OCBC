...
class ReplayBuffer:
    ...
    def add_trajectory(self, states, actions, desired_state, w, length_of_traj=None):
        """
        ...
        self._imp_weights[self.pointer] = w
    ...
    def _get_batch(self, traj_idxs, time_state_idxs, time_goal_idxs):
        ...
        com_goals = self._desired_states[traj_idxs,-int(self._states.shape[2]/3):]
        imp_weights = self._imp_weights[traj_idxs]
        #pdb.set_trace()
        ...
        return observations, actions, goals,com_goals,imp_weights,lengths, horizons, weights
